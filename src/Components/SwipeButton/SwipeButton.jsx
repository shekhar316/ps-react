...
import { Container, Text, Center, Button, Box } from "@chakra-ui/react";
...
export default class SwipeableButton extends Component {
  ...
  getText =()=> {
    return this.state.unlocked ? (this.props.text_unlocked || 'CONFIRMING...') : (this.props.text || 'SLIDE')
  }
    ...
    return (
        <div className='ReactSwipeButton'>
            <div className={'rsbContainer ' + (this.state.unlocked ? 'rsbContainerUnlocked' : '')} ref={container}>
                ...
                <div className='rsbcText'>SWIPE TO STOP</div>
            </div>
        </div>
    )
  }
